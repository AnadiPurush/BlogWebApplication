            ...
            <div id="site_div">
                ...
                <div id="header">
                    <div id="logo">
                        ...
                        <br/>
                        <br/><span><font style="color:maroon" size="32"><b>BlogPost</b></font></span>
...
// HERE replace the values with the text you want to be displayed near Select
 ...
 "     s1_opt2": ['s1o2_opt1', 's1o2_opt2']
    ...
    /*
     ...
     The key in this object must be the same with the val     ues (options) added in each Array in "slist2" above
    ...
    SList.slist3 = {
       ...
       "s1o2_o     pt2": ['s2o2_2_opt1', 's2o2_2_opt2']
    };

    /*
     Property with content     associated to the options of the third select list
     The key in this object must be the same with the val     ues (options) added in each Array in "slist3" above
