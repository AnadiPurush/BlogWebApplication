<%-- 
    Document   : upload
    Created on : 5 Dec 2022, 12:09:30
    Author     : utsav
--%>
...
String connectionURL = "jdbc:mysql://localhost:3306/JavaBlogDB";;
ResultSet rs = null;
PreparedStatement psmnt = null;
FileInputStream fis;
try {
Class.forName("com.mysql.cj.jdbc.Driver");
connection = DriverManager.getConnection(connectionURL, "root", "Utsav@9575?");
